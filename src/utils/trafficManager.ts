...
function resolveMovement(creep: CreepType): void {
 ...
 */
function canMove(creep: CreepType): boolean {
...
function getIntendedPackedCoord(creep: CreepType): number | undefined {
  return (creep as any)._intendedPackedCoord
}

function getMatchedPackedCoord(creep: CreepType): number | undefined {
  return (creep as any)._matchedPackedCoord
}

function deleteMatchedPackedCoord(creep: CreepType): void {
